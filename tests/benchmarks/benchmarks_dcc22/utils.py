...
def extract_fasta(out_file_path, ref_file, vcf_file, sample_id, haplotype="1"):
    rootLogger = logging.getLogger()
    bcf_command = "bcftools consensus -H {} -f {} -s {} {} -o {}".format(
        haplotype, ref_file, sample_id, vcf_file, out_file_path)
